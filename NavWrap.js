    ...
    render() {
        return (
            <View style={{height: "100%", width: "100%", backgroundColor: "white"}}>
                ...
                <View
                    style={{backgroundColor: "#4285F4", height: 80.0, width: "100%", flexDirection: "row", padding: 0}}>
                    <View style={this.props.selected === 0 ? style.buttonWrapActive : style.buttonWrap}>
                        <TouchableOpacity style={style.button}
                                          onPress={() => this.props.nav.displayScreen(global.ScreenEnum.Closet)}>
                    ...
                    <View style={this.props.selected === 1 ? style.buttonWrapActive : style.buttonWrap}>
                        <TouchableOpacity style={style.button}
                                          onPress={() => this.props.nav.displayScreen(global.ScreenEnum.Outfits)}>
                    ...
                    <View style={this.props.selected === 3 ? style.buttonWrapActive : style.buttonWrap}>
                        <TouchableOpacity style={style.button}
                                          onPress={() => this.props.nav.displayScreen(global.ScreenEnum.Feed)}>
                    ...
                    <View style={this.props.selected === 4 ? style.buttonWrapActive : style.buttonWrap}>
                        <TouchableOpacity style={style.button}
                                          onPress={() => this.props.nav.displayScreen(global.ScreenEnum.Profile)}>
